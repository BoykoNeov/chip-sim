...
def test_the_transistor_is_the_real_untouched_device_chain(r):
...
def test_the_wire_term_is_blind_to_the_transistor_and_the_gate_term_is_flat(r):
...
def test_the_wall_is_monotone_and_a_crossing_exists_for_both_metals(r):
...
def test_the_damping_law_is_exact_and_the_premise_is_the_diagonal(r):
...
def test_the_bulk_axis_is_exhausted_and_the_claim_is_scoped_to_that_axis(r):
...
def test_the_transistors_own_progress_pulls_the_wall_in_by_the_same_root(r):
...
# --------------------------------------------------------------------------- #
def test_the_fourth_panel_is_a_SEPARATE_axis_and_does_not_continue_the_ladder(r):
...
def test_the_fourth_panels_ladder_needs_BOTH_mechanisms_to_get_the_sign_right(r):
...
def test_the_fourth_panel_carries_both_impossibility_results_and_the_band(r):
