...
#   ./run_tests.ps1 -m "not slow" -n auto    # routine fast lane, PARALLEL (~11 s vs ~26 s serial)
#   ./run_tests.ps1                          # full gate, SERIAL — adds the slow notebook test (~33 s, always safe)
